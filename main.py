...
def main():
    ...
    var2 = ['Με δημιούργησε ο Μάκης όταν όλος ο κόσμος τον έπαιζε με τον κορονοϊό', 'Μάκης', 'Ένας τυπάς που δεν έχω γνωρίσει ποτέ']
    var4 = ['ποιά είσαι', 'πώς σε λένε']
    jokes = ['Το μουνί της μάνας σου. Σάρεσε το αστείο;','Ο Μιχάλης είναι άντρακλας']
    cmd9 = ['ευχαριστώ']
    ...
    while text.count("αναμονή λειτουργίας") < 1 or loop < 5:
        ...
        if text in greetings:
            ...
            webbrowser.open("D:/Music/System Of A Down - Chop Suey!.mp3")
        elif text in var4:
            speak('Είμαι η Σόνια')
